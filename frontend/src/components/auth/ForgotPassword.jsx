...
const S = {
  ...
  back:  { display:'block', textAlign:'center', marginTop:14, fontSize:13, color:'#0f9e8e', textDecoration:'none' },
}
      ...
      <div style={S.card}>
        ...
        {sent ? (
          <div style={{ textAlign:'center' }}>
            ...
            <Link to="/login" style={{ color:'#0f9e8e', fontSize:13, textDecoration:'none' }}>← Back to sign in</Link>
          </div>
        ) : (
